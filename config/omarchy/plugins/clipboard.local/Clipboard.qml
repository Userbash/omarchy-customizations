          ...
          Row {
            ...
            Item {
              ...
              GridView {
                ...
                anchors.fill: parent
                model: displayModel
                cellWidth: Style.space(190)
                cellHeight: Style.space(170)
                delegate: Item {
                  ...
                  Text { anchors.bottom: parent.bottom; text: previewText; elide: Text.ElideRight; width: parent.width; color: root.foreground }
                }
              }
            }
